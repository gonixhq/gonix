-- 135_anon_result_full.sql
-- ขยาย get_anon_result ให้ส่งข้อมูลครบสำหรับ "ใบ Laboratory Report" ฝั่งคนไข้ (โหลด PDF หน้า /result)
-- เพิ่ม: masthead คลินิก (ชื่อ EN/บริษัท/ที่อยู่/เลขใบอนุญาต/เลขภาษี/โลโก้) + ข้อมูลใบผล
-- (sex/age/LAB No./sample type/เวลาเก็บ-รับ/ผู้รายงาน-อนุมัติ/meta) + ค่าผลจริง(result_value)
-- คง logic rate-limit + verify เดิมทุกอย่าง (SECURITY DEFINER)
