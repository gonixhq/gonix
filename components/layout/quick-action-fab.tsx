...
export default function QuickActionFab() {
    ...
    if (/^\/dashboard\/pharmacy\/[^/]+\/?$/.test(pathname || "") || pathname?.startsWith("/dashboard/patients/new") || pathname?.startsWith("/dashboard/visits/new") || /^\/dashboard\/screening\/[^/]+\/?$/.test(pathname || "")) return null;
