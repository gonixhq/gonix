...
const PAGE_TITLES: TitleEntry[] = [
    ...
    { pattern: "/dashboard/checkin", th: "ตอกบัตร (GPS)", en: "Clock In/Out" },
    ...
    { pattern: "/dashboard/compensation", th: "ค่าตอบแทนพนักงาน", en: "Compensation", sub: { th: "ค่าจ้าง + DF/คอม + คอมทีม", en: "Pay + DF + team commission" } },
    ...
    { pattern: "/dashboard/inventory/new", th: "เพิ่มสินค้าในคลัง", en: "New Inventory Item" },
    { pattern: /^\/dashboard\/inventory\/[^/]+\/edit$/, th: "แก้ไขสินค้า", en: "Edit Inventory Item" },
    { pattern: /^\/dashboard\/inventory\/packages(\/[^/]+)?$/, th: "คอสบริการ", en: "Service Packages" },
    { pattern: /^\/dashboard\/inventory\/[^/]+$/, th: "รายละเอียดสินค้า", en: "Inventory Item" },
